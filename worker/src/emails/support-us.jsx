      ...
      <Body style={mainStyle}>
        <Container style={containerStyle}>
          ...
          <Section style={logoSectionStyle}>
           <Img src={'https://www.vaguinhas.com.br/vaguinhas-logo.png'} 
    // src={`${baseURL}/public/static/vaguinhas-logo.png`}
    alt="vaguinhas logo" width="200" style={logoStyle}/>
          </Section>
          ...
          <Section style={pixSectionStyle}>
            ...
            <Img src={'https://www.vaguinhas.com.br/qrcode-pix.png'} 
    // src={`${baseURL}/public/static/qrcode-pix.png`}
    alt="QR Code PIX" width="180" height="180" style={pixQrStyle}/>
